...
#
#     def __init__(self, synthetic_root, is_crop=True, mode = 'train'):
#         #self.gt_root = gt_root
#         #self.mask_root = mask_root
#         self.synthetic_root = synthetic_root
#         self.is_crop = is_crop
#         self.mode = mode
#         self.imgs_list = os.listdir(synthetic_root)
...
#                     #         mask_light[i,j] = 1
#             # mask_tensor = mask_tensor[:, y:y + 64, x:x + 64]
#             synthetic_tensor = synthetic_tensor[:, y:y + 128, x:x + 128]
#
