...
if __name__ == '__main__':
    ...
    # check = torch.load(os.path.join(args.dir, 'checkpoints_G_Res_five_block_find_fault_itea42.pth'), map_location=torch.device('cpu'))
    ...
    while iteration < args.iterations:
        ...
        if (iteration % 3 == 0):
            ...
            torch.save(checkpoint, os.path.join(args.dir, 'checkpoints_G_Res_five_block_find_fault_itea_RC{}.pth'.format(iteration)))
            # check = {
            #     'iteration': iteration,
