...
from Net_Tool_sec_baseline import *
from Loss import *
...
if __name__ == '__main__':
    ...
    check_path = 'Weight/checkpoints_G_Res_five_block_find_fault_itea_PAP12.pth'
    ...
    for i in li_snow:
        ...
        with torch.no_grad():
            for data in data_loader:
                ...
                snow_sa = snow_img
                A_sa = 1-A
                save_image(A_sa, "PAP_image/" + i + "_result_%d.png" % number, nrow=1, normalize=False)
