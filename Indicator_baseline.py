...
if __name__ == '__main__':
    ...
    check_path = 'Weight/checkpoints_G_Res_five_block_find_fault_itea_baseline21.pth'
    ...
    for i in li_snow:
        ...
        with torch.no_grad():
            for data in data_loader:
                ...
                save_image(1-A, "baseline_image/" + i + "_result_%d.png" % number, nrow=1, normalize=False)
                # g = gt_img.cpu()
                # f = Image_1.cpu()
